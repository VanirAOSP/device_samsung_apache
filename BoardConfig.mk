...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/samsung/apache/bluetooth
BOARD_BLUEDROID_VENDOR_CONF := device/samsung/apache/bluetooth/vnd_apache.txt

BOARD_MOBILEDATA_INTERFACE_NAME = "pdp0"

BOARD_RIL_CLASS := ../../../device/samsung/apache/ril/
...
TARGET_QCOM_DISPLAY_VARIANT := legacy-legacy
TARGET_QCOM_MEDIA_VARIANT := legacy-legacy
